...
const report = async function(data) {
  const title = "Salida de almacen";
  const subject = "Salida de almacen";
  const keywords = "salida, almacen";
  ...
  /** Details */
  let details_widths = [15, 50, 60, 40, "*", 90];
  ...
  details_print.push([
    { text: `Total`, fillColor: "#CCCCCC", alignment: "right", colSpan: 5 },
    { text: `` },
    { text: `` },
    { text: `` },
    { text: `` },
    ...
    content: [
        ...
        table: {
          ...
          body: [
            [
              ...
              { text: `Salida`, alignment: "left" },
              { text: `${formatDate(master.date_of, "MMMM d, yyyy")}`, alignment: "center" }
            ],
            [
              { text: `Destino`, alignment: "left" },
              { text: `${getData(master, "destino", "").toUpperCase()}`, alignment: "left" },
      ...
      },
      {
        ...
        table: {
          ...
          body: [
            [
              { text: `Solicito`, alignment: "left" },
              { text: `${getData(master, "solicito", "").toUpperCase()}`, alignment: "left" },
              { text: `Recibio`, alignment: "left" },
              { text: `${getData(master, "recibio", "").toUpperCase()}`, alignment: "left" }
            ],
            [
              { text: `Entrego`, alignment: "left" },
              { text: `${getData(master, "entrego", "").toUpperCase()}`, alignment: "left" },
              { text: `Aprobo`, alignment: "left" },
              { text: `${getData(master, "aprobo", "").toUpperCase()}`, alignment: "left" }
            ]
          ]
        },
        layout: tableLayout
      ...
      },
      {
        ...
        table: {
          ...
          body: [
            [
              { text: `Observaciones: ${master.observations}`, alignment: "left", colSpan: 4, maxHeight: 30 },
              { text: ``, maxHeight: 30 },
              { text: ``, maxHeight: 30 },
              { text: ``, maxHeight: 30 }
            ],
            ...
            [
              { text: `Solicito: ${getData(master, "solicito", "")}`, alignment: "center", maxHeight: 10 },
              { text: `Recibio: ${getData(master, "recibio", "")}`, alignment: "center", maxHeight: 10 },
              { text: `Entrego: ${getData(master, "entrego", "")}`, alignment: "center", maxHeight: 10 },
              { text: `Aprobo: ${getData(master, "aprobo", "")}`, alignment: "center", maxHeight: 10 }
            ]
          ]
        },
        layout: tableLayout
